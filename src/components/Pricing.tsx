...
const data = {
  ...
  rows: [
    ...
    },
    {
      ...
      content: `For the Whitelist Private Sale the price will be 0,1 ETH + gas price and you will be able to mint a max of 3 Workers. For the Public Sale the price will be 0,15 ETH + gas price and you will be able to mint a max of 5 Workers.`,
    },
    {
      title: 'How do I purchase an NFT?',
      content:
        'First, you will need to purchase Ethereum (ETH) from a cryptocurrency exchange such as Coinbase, Binance, or Gemini. Then, you will need to transfer your ETH into a digital wallet, the most popular being Metamask. You will be able to connect this wallet to the Metaverse Workers website to purchase your NFT.',
    },
    {
    ...
    },
    {
      ...
      content:
        'Yes, In the sum of eth price not including transaction fees, The Metaverse Workers hereby transfers to purchasers full title and all rights and interests with 2.5% secondary royalty, You will be the owner of the nft and it is absolutely 1/1 & Secured on ERC-72 token.',
    },
  ],
};
